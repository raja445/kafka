...
# Attributes:: default
default["flume_collector"]["version"] = "1.6.0.40"
default["flume_collector"]["download_url"] = "http://plgw4001.grid.dfw1.inmobi.com/tar/apache-flume-1.6.0.40-bin.tar.gz"
...
default["flume_collector"]["endcollector_platinum_retention_topics"]['dfw1']  = "testmerge,user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,tpce_custom_goal_summary,tpce_enriched_download,tpce_purchase_summary,ucm_mapping,ifc_photon_enriched_san_pb,beeswax_bid_logs,dsp_segments,genesis_postback,optout,ifc_attributes,ifc_cookie_organic_activity,wclick_dfw1,normalized_postback,beeswax_download_event,beeswax_post_install_event,ifc_inmobi_api_user_segments,adroit_attribution_stats,iapclick,iapattribution,iapbilling"
...
default["flume_collector"]["endcollector_all_sinks"]['dfw1'] = "kafkasink1 kafkasink2 kafkasink3 mergekafkasink hdfsmerge-sink hdfslocal-sink1 hdfslocal-sink2 hdfslocal-sink3 platinumhdfs-sink1 platinumhdfs-sink2 platinumhdfs-sink3 platinumhdfs-sink4 platinumhdfs-sink5 photon-mergekafkasink"
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ucm_mapping,ifc_photon_enriched_san_pb,beeswax_bid_logs,dsp_segments,genesis_postback,optout,ifc_attributes,ifc_cookie_organic_activity,wclick_dfw1,normalized_postback,beeswax_download_event,beeswax_post_install_event,ifc_inmobi_api_user_segments,adroit_attribution_stats,iapclick,iapattribution,iapbilling"},
     "hdfsplatinummergesrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "merge_testmerge,merge_tpce_custom_goal_summary,merge_tpce_enriched_download,merge_tpce_purchase_summary"},
     "dfw1kafkamergesrc" => {
     ...
     "dfw2kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_dfw1_cpm_render,network_beacon_dfw1_adunit,network_beacon_dfw1_publisherfill,beacon_rr_dfw1_default,network_beacon_adunit_interaction_dfw1,beacon_rr_dfw1_cpc_render,ifc_ff_dfw1,non_network_click_cpc_dfw1,non_network_click_cpm_dfw1,network_click_cpc_dfw1,network_click_cpm_dfw1,network_click_invalid_dfw1,click_rr_dfw1,beeswax_user_segment,iat_click,cookie_mapping,photon_visit_summary,appd_s2spinger_stats,tpce_download,tpce_enriched_download,tpce_purchase,tpce_purchase_summary,tpce_custom_goal,tpce_custom_goal_summary,tpce_user_segment_summary,tpce_ltv_summary"},
     "ams1kafkamergesrc" => {
...
default["flume_collector"]["endcollector_platinum_retention_topics"]['dfw2']  = "testmerge,user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ifc_cookie_organic_activity,ifc_photon_enriched_san_pb,beeswax_bid_logs,adroit_attribution_stats"

default["flume_collector"]["endcollector_all_channels"]['dfw2']  = "spillable mergespillable hdfsmerge-channel hdfslocal-channel platinumhdfs-channel photon-mergespillable-channel"

default["flume_collector"]["endcollector_all_sinks"]['dfw2'] = "kafkasink mergekafkasink hdfsmerge-sink hdfslocal-sink1 platinumhdfs-sink1 platinumhdfs-sink2 platinumhdfs-sink3 platinumhdfs-sink4 platinumhdfs-sink5 photon-mergekafkasink"
#Configure the sources for the Flume Collector
default["flume_collector"]["endcollector_sources"]['dfw2']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ifc_cookie_organic_activity,ifc_photon_enriched_san_pb,beeswax_bid_logs,adroit_attribution_stats"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
...
default["flume_collector"]["endcollector_sources"]['ams1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ifc_cookie_organic_activity,ifc_photon_enriched_san_pb,beeswax_bid_logs,il-flat_activity_add-ifcorganicactivity,adroit_attribution_stats"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
     ...
     "dfw1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_ams1_cpm_render,network_beacon_ams1_adunit,network_beacon_ams1_publisherfill,beacon_rr_ams1_default,network_beacon_adunit_interaction_ams1,beacon_rr_ams1_cpc_render,ifc_ff_ams1,non_network_click_cpc_ams1,non_network_click_cpm_ams1,network_click_cpc_ams1,network_click_cpm_ams1,network_click_invalid_ams1,click_rr_ams1,datasciences-attributes_ams1,adroit_report_obj_ams1,billing_cpc_ams1,billing_cpm_ams1,billing_download_ams1"},
     "lhr1kafkamergesrc" => {
         :src_category => "lhr1kafkamerge",
...
default["flume_collector"]["endcollector_platinum_retention_topics"]['lhr1']  = "testmerge,user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ifc_cookie_organic_activity,ifc_photon_enriched_san_pb,beeswax_bid_logs,adroit_attribution_stats"
...
default["flume_collector"]["endcollector_platinum_retention_topics"]['pek1']  = "testmerge,user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,wclick_pek1,ifc_photon_enriched_san_pb,adroit_attribution_stats,ifc_cookie_organic_activity,iapclick"

default["flume_collector"]["endcollector_all_channels"]['pek1']  = "spillable  mergespillable hdfslocal-channel  hdfsmerge-channel platinumhdfs-channel photon-mergespillable-channel"

default["flume_collector"]["endcollector_all_sinks"]['pek1'] = "kafkasink  mergekafkasink hdfslocal-sink  hdfsmerge-sink platinumhdfs-sink1 platinumhdfs-sink2 platinumhdfs-sink3 platinumhdfs-sink4 platinumhdfs-sink5 photon-mergekafkasink"
#Configure the sources for the Flume Collector
default["flume_collector"]["endcollector_sources"]['pek1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,wclick_pek1,ifc_photon_enriched_san_pb,adroit_attribution_stats,ifc_cookie_organic_activity,iapclick"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
