...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "ams1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
	 :'kafka.topics' => "network_beacon_dfw1_publisherfill,beacon_rr_dfw1_default,network_beacon_adunit_interaction_dfw1,ifc_ff_dfw1,non_network_click_cpc_dfw1,non_network_click_cpm_dfw1,network_click_cpc_dfw1,network_click_cpm_dfw1,network_click_invalid_dfw1,click_rr_dfw1,beeswax_user_segment,iat_click,cookie_mapping,photon_visit_summary,appd_s2spinger_stats,photon_userid_type,beeswax_post_install_event,tpce_download"},
