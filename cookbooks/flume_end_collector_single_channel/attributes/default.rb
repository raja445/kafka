...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "dfw2kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_dfw1_cpm_render,network_beacon_dfw1_adunit,network_beacon_dfw1_publisherfill,beacon_rr_dfw1_default,network_beacon_adunit_interaction_dfw1,beacon_rr_dfw1_cpc_render,ifc_ff_dfw1,non_network_click_cpc_dfw1,non_network_click_cpm_dfw1,network_click_cpc_dfw1,network_click_cpm_dfw1,network_click_invalid_dfw1,click_rr_dfw1,beeswax_user_segment,iat_click,cookie_mapping,photon_visit_summary,appd_s2spinger_stats,tpce_download,tpce_enriched_download,tpce_purchase,tpce_purchase_summary,tpce_custom_goal,tpce_custom_goal_summary,tpce_user_segment_summary,tpce_ltv_summary,bidder_metrics"},
     "ams1kafkamergesrc" => {
...
default["flume_collector"]["endcollector_sources"]['ams1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ifc_cookie_organic_activity,ifc_photon_enriched_san_pb,beeswax_bid_logs,il-flat_activity_add-ifcorganicactivity,adroit_attribution_stats,ucm_mapping,adomain_meta"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
...
default["flume_collector"]["endcollector_sources"]['pek1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,wclick_pek1,ifc_photon_enriched_san_pb,adroit_attribution_stats,ifc_cookie_organic_activity,iapclick,ucm_mapping,adomain_meta"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
