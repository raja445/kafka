...
# Attributes:: default
default["flume_collector"]["version"] = "1.6.0.21"
default["flume_collector"]["download_url"] = "http://glvm1014.grid.uh1.inmobi.com/tar/apache-flume-1.6.0.21-bin.tar.gz"
...
default["flume_collector"]["endcollector_merge_retention_topics"]['uh1']  = "beacon_rr_uh1_cpm_render,network_beacon_uh1_adunit,network_beacon_uh1_publisherfill"
...
default["flume_collector"]["endcollector_sources"]['uh1']  = {
     ...
     "hdfsmergesrc" => {
         ...
         :batchSize => 500,
         :'kafka.topics' => "merge_beacon_rr_uh1_cpm_render,merge_network_beacon_uh1_adunit,merge_network_beacon_uh1_publisherfill"},
     "uh1-to-uh1-mergesrc1" => {
         ...
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_uh1_cpm_render,network_beacon_uh1_adunit,network_beacon_uh1_publisherfill"},
     "uh1-to-dfw1-mergesrc1" => {
         ...
         :'selector.type' => "org.apache.flume.channel.RoundRobinChannelSelector",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_dfw1_cpm_render,network_beacon_dfw1_adunit,network_beacon_dfw1_publisherfill"},
     "uh1-to-lhr1-mergesrc1" => {
         ...
         :'selector.type' => "org.apache.flume.channel.RoundRobinChannelSelector",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_lhr1_cpm_render,network_beacon_lhr1_adunit,network_beacon_lhr1_publisherfill"},
     "uh1-to-pek1-mergesrc1" => {
         ...
         :'selector.type' => "org.apache.flume.channel.RoundRobinChannelSelector",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_pek1_cpm_render,network_beacon_pek1_adunit,network_beacon_pek1_publisherfill"}
       }
...
default["flume_collector"]["endcollector_merge_retention_topics"]['dfw1']  = "beacon_rr_dfw1_cpm_render,network_beacon_dfw1_adunit,network_beacon_dfw1_publisherfill"
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "hdfsmergesrc" => {
         ...
         :channels => "hdfsmerge-channel",
         :batchSize => 500,
         :'kafka.topics' => "merge_beacon_rr_dfw1_cpm_render,merge_network_beacon_dfw1_adunit,merge_network_beacon_dfw1_publisherfill"},
     "dfw1-to-uh1-mergesrc1" => {
         ...
         :'selector.type' => "org.apache.flume.channel.RoundRobinChannelSelector",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_uh1_cpm_render,network_beacon_uh1_aduniti,network_beacon_uh1_publisherfill"},
...
default["flume_collector"]["endcollector_merge_retention_topics"]['lhr1']  = "beacon_rr_lhr1_cpm_render,network_beacon_lhr1_adunit,network_beacon_lhr1_publisherfill"
...
default["flume_collector"]["endcollector_sources"]['lhr1']  = {
     ...
     "hdfsmergesrc" => {
         ...
         :channels => "hdfsmerge-channel",
         :batchSize => 500,
         :'kafka.topics' => "merge_beacon_rr_lhr1_cpm_render,merge_network_beacon_lhr1_adunit,merge_network_beacon_lhr1_publisherfill"},
...
default["flume_collector"]["endcollector_merge_retention_topics"]['pek1']  = "beacon_rr_pek1_cpm_render,network_beacon_pek1_adunit,network_beacon_pek1_publisherfill"
...
default["flume_collector"]["endcollector_all_sinks"]['pek1'] = "kafkasink  mergekafkasink  uh1-mergesink1 uh1-mergesink2 dfw1-mergesink1 dfw1-mergesink2 lhr1-mergesink1 lhr1-mergesink2 pek1-mergesink1 pek1-mergesink2 hdfslocal-sink  hdfsmerge-sink"
#Configure the sources for the Flume Collector
default["flume_collector"]["endcollector_sources"]['pek1']  = {
     ...
     "hdfsmergesrc" => {
         ...
         :channels => "hdfsmerge-channel",
         :batchSize => 500,
         :'kafka.topics' => "merge_beacon_rr_pek1_cpm_render,merge_network_beacon_pek1_adunit,merge_network_beacon_pek1_publisherfill"},
