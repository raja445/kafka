...
default["flume_collector"]["endcollector_sources"]['uh1']  = {
     ...
     "dfw1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "billable_render_dfw1,beacon_rr_uh1_cpm_render"},
     "lhr1kafkamergesrc" => {
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "dfw1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_dfw1_cpm_render"},
     "lhr1kafkamergesrc" => {
         :src_category => "lhr1kafkamerge",
