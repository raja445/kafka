...
default["flume_collector"]["endcollector_platinum_retention_topics"]['pek1']  = "testmerge,user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,wclick_pek1,ifc_photon_enriched_san_pb,adroit_attribution_stats,ifc_cookie_organic_activity,iapclick,il-flat_activity_add-ifcorganicactivity"
...
default["flume_collector"]["endcollector_sources"]['pek1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,wclick_pek1,ifc_photon_enriched_san_pb,adroit_attribution_stats,ifc_cookie_organic_activity,iapclick,il-flat_activity_add-ifcorganicactivity"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
