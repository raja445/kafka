...
default["flume_collector"]["endcollector_all_channels"]['dfw1']  = "spillable mergespillable hdfsmerge-channel hdfslocal-channel platinumhdfs-channel photon-mergespillable-channel dfw1-to-ams1-kafkamerge-channel"
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "dfw1-to-ams1-kafkamergesrc" => {
         ...
         :batchSize => 500,
         :'kafka.topics' => "photon_appd_flat_activity_ams1,billing_cpm_ams1"},
     "ams1photonmergesrc" => {
         :src_category => "ams1kafkamerge",
         :consumer_group => "ams1-to-dfw1-kafkamerge",
         :type => "org.apache.flume.source.kafka.MultiKafkaSource",
...
default["flume_collector"]["endcollector_sources"]['ams1']  = {
     ...
     "dfw1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_ams1_cpm_render,network_beacon_ams1_adunit,network_beacon_ams1_publisherfill,beacon_rr_ams1_default,network_beacon_adunit_interaction_ams1,beacon_rr_ams1_cpc_render,ifc_ff_ams1,non_network_click_cpc_ams1,non_network_click_cpm_ams1,network_click_cpc_ams1,network_click_cpm_ams1,network_click_invalid_ams1,click_rr_ams1,datasciences-attributes_ams1,adroit_report_obj_ams1,billing_cpc_ams1,billing_download_ams1,billing_download_lhr1"},
     "pek1kafkamergesrc" => {
         :src_category => "pek1kafkamerge",
