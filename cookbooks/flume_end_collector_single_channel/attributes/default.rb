...
default["flume_collector"]["endcollector_sources"]['uh1']  = {
     ...
     "uh1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_uh1_cpm_render,billing_cpc_uh1,billing_cpm_uh1,billing_download_uh1"},
     "uh1-to-uh1-mergesrc" => {
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "uh1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_dfw1_cpm_render,billing_cpc_dfw1,billing_cpm_dfw1,billing_download_dfw1"},
...
default["flume_collector"]["endcollector_sources"]['lhr1']  = {
     ...
     "uh1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_lhr1_cpm_render,billing_cpc_lhr1,billing_cpm_lhr1,billing_download_lhr1"},    
...
default["flume_collector"]["endcollector_sources"]['pek1']  = {
     ...
     "uh1kafkamergesrc" => {
         ...
         :channels => "mergespillable",
         :batchSize => 500,
         :'kafka.topics' => "beacon_rr_pek1_cpm_render,billing_cpc_pek1,billing_cpm_pek1,billing_download_pek1"},
