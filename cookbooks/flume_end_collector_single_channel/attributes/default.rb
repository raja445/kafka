...
default["flume_collector"]["endcollector_platinum_retention_topics"]['dfw1']  = "testmerge,user_context,ifc_photon_enriched_postback"
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback"},
