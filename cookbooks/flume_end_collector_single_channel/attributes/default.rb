...
default["flume_collector"]["endcollector_platinum_retention_topics"]['dfw1']  = "testmerge,user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,tpce_custom_goal_summary,tpce_enriched_download,tpce_purchase_summary,ucm_mapping,ifc_photon_enriched_san_pb,beeswax_bid_logs,dsp_segments,genesis_postback,optout,ifc_attributes,ifc_cookie_organic_activity,wclick_dfw1,normalized_postback,beeswax_download_event,beeswax_post_install_event,ifc_inmobi_api_user_segments,adroit_attribution_stats,iapclick,iapattribution,iapbilling,adomain_meta"
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ucm_mapping,ifc_photon_enriched_san_pb,beeswax_bid_logs,dsp_segments,genesis_postback,optout,ifc_attributes,ifc_cookie_organic_activity,wclick_dfw1,normalized_postback,beeswax_download_event,beeswax_post_install_event,ifc_inmobi_api_user_segments,adroit_attribution_stats,iapclick,iapattribution,iapbilling,adomain_meta"},
...
default["flume_collector"]["endcollector_sources"]['ams1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,ifc_cookie_organic_activity,ifc_photon_enriched_san_pb,beeswax_bid_logs,il-flat_activity_add-ifcorganicactivity,adroit_attribution_stats,adomain_meta"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
...
default["flume_collector"]["endcollector_sources"]['pek1']  = {
     ...
     "hdfsplatinumsrc" => {
         ...
         :channels => "platinumhdfs-channel",
         :batchSize => 500,
         :'kafka.topics' => "user_context,ifc_photon_enriched_postback,dsp-beacon,sandboxrr,sandbox_postimpression,wclick_pek1,ifc_photon_enriched_san_pb,adroit_attribution_stats,ifc_cookie_organic_activity,iapclick,adomain_meta"},
     "hdfsplatinummergesrc" => {
         :src_category => "mergetoplatinumhdfs",
