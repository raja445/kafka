...
template "#{flumeConf}/flume-end-collector.properties" do
  ...
  variables(
    ...
    :local_eventhub_sinks4 =>node["flume_collector"]["endcollector_local_eventhub_sinks4"]['dfw1'],
    :local_eventhub_sinks5 =>node["flume_collector"]["endcollector_local_eventhub_sinks5"]['dfw1'],
    :local_eventhub_sinks6 =>node["flume_collector"]["endcollector_local_eventhub_sinks6"]['dfw1'],
    :local_eventhub_sinks7 =>node["flume_collector"]["endcollector_local_eventhub_sinks7"]['dfw1'],
    :local_eventhub_sinks8 =>node["flume_collector"]["endcollector_local_eventhub_sinks8"]['dfw1'],
