...
template "#{flumeConf}/flume-end-collector.properties" do
  ...
  variables(
    ...
    :dfw1_eventhub_sinks18 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks18"]['dfw1'],
    :dfw1_eventhub_sinks19 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks19"]['dfw1'],
    :dfw1_eventhub_sinks20 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks20"]['dfw1'],
    :dfw1_eventhub_sinks21 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks21"]['dfw1'],
    :dfw1_eventhub_sinks22 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks22"]['dfw1'],
    :dfw1_eventhub_sinks23 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks23"]['dfw1'],
    :dfw1_eventhub_sinks24 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks24"]['dfw1'],
    :dfw1_eventhub_sinks25 =>node["flume_collector"]["endcollector_dfw1_eventhub_sinks25"]['dfw1'],
