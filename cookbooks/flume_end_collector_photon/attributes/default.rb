...
default["flume_collector"]["download_url"] = "http://pygw4003.grid.pek1.inmobi.com/tar/apache-flume-1.6.0.56-bin.tar.gz"
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
    ...
    "eventhublocalsrc19" => {
         ...
         :consumer_group => "dfw1eventhublocal17",
         :type => "org.apache.flume.source.kafka.MultiKafkaSource",
         :channels => "eventhublocal-channel18",
         :batchSize => 500,
         :'kafka.topics' => "billing_cpm_us_east"},
    "eventhublocalsrc20" => {
         :src_category => "dfw1eventhublocal17",
...
default["flume_collector"]["endcollector_local_eventhub_channels"]['dfw1']  = ["eventhublocal-channel6","eventhublocal-channel7","eventhublocal-channel8","eventhublocal-channel14","eventhublocal-channel15","eventhublocal-channel16","eventhublocal-channel17","eventhublocal-channel18"]
...
default["flume_collector"]["endcollector_dfw1_eventhub_sinks18"]['dfw1']  = {
     "kestrelsink19" => {:channel => "eventhublocal-channel17",:cluster =>"onyx"},
}
default["flume_collector"]["endcollector_dfw1_eventhub_sinks19"]['dfw1']  = {
     "kestrelsink20" => {:channel => "eventhublocal-channel17",:cluster =>"onyx"},
}
default["flume_collector"]["endcollector_dfw1_eventhub_sinks20"]['dfw1']  = {
     "kestrelsink21" => {:channel => "eventhublocal-channel17",:cluster =>"onyx"},
}
default["flume_collector"]["endcollector_dfw1_eventhub_sinks21"]['dfw1']  = {
     "kestrelsink22" => {:channel => "eventhublocal-channel18",:cluster =>"onyx"},
}
default["flume_collector"]["endcollector_dfw1_eventhub_sinks22"]['dfw1']  = {
     "kestrelsink23" => {:channel => "eventhublocal-channel18",:cluster =>"onyx"},
}
default["flume_collector"]["endcollector_dfw1_eventhub_sinks23"]['dfw1']  = {
     "kestrelsink24" => {:channel => "eventhublocal-channel18",:cluster =>"onyx"},
}
default["flume_collector"]["endcollector_dfw1_eventhub_sinks24"]['dfw1']  = {
     "kestrelsink25" => {:channel => "eventhublocal-channel18",:cluster =>"onyx"},
}
default["flume_collector"]["endcollector_dfw1_eventhub_sinks25"]['dfw1']  = {
     "kestrelsink26" => {:channel => "eventhublocal-channel18",:cluster =>"onyx"},
}
...
default["flume_collector"]["endcollector_all_sinks"]['pek1'] = "mergekafkasink hdfslocal-sink  hdfsmerge-sink platinumhdfs-sink1 platinumhdfs-sink2 platinumhdfs-sink3 hdfslocalsecure-sink1  hdfslocalsecure-sink2 hdfslocalsecure-sink3 hdfslocalsecure-sink4 hdfsmergesecure-sink platinumhdfssecure-sink1 platinumhdfssecure-sink2 platinumhdfssecure-sink3"
#Configure the sources for the Flume Collector
default["flume_collector"]["endcollector_sources"]['pek1']  = {
     "hdfslocalsrc" => {
         ...
         :channels => "hdfslocalsecure-channel",
         :batchSize => 500,
         :'kafka.topics' => "profile_delete-appd,attribute_change-appd,attribute_change-brand,attribute_change-core,attribute_change-ifc,profile_delete-brand,profile_delete-core,profile_delete-ifc,custom_type_record_update-appduserclickhistory,custom_type_record_update-appduserrenderhistory,custom_type_record_update-appduserscore,custom_type_record_update-branduseractivityhistory,custom_type_record_update-ifc,custom_type_record_update-appdlookaliketype,custom_type_record_update-core,custom_type_record_update-ifcinorg,flat_activity_add-appdcustomactivity,flat_activity_add-appddownloadactivity,flat_activity_add-appdpurchaseactivity,flat_activity_add-appds2scustomsegmentactivity,flat_activity_add-coredownloadactivity,flat_activity_add-ifcorganicactivity,nested_activity_add-appd,nested_activity_add-cas,nested_activity_add-network,adroit_report_obj_pek1,appd_attribute_errors,appd-debug,brand_attribute_pek1_pek1,ifc_photon_nonenriched_pb_pek1,nested_activity_add-ifcuseractivity,network_attribute_raw_pek1,ttd-beacon,ttd-request,usermeta_change,wadogorr,network_beacon_pek1_pek1,network_activity_pek1_pek1,nested_activity_add-ifc,fdsPek1,georrcore,georrmetrics,napp,perfRR,supplyRR,sdk_health_monitoring,sdk_crash_analytics,sdk_trc,imei_usermeta_change,china-dmp-data,china-dmp-data-idfa"},
     "hdfsmergesrc" => {
         :src_category => "hdfsmerge",
