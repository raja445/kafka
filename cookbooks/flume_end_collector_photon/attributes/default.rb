...
# Attributes:: default
default["flume_collector"]["version"] = "1.6.0.54"
default["flume_collector"]["download_url"] = "http://plgw4001.grid.dfw1.inmobi.com/tar/apache-flume-1.6.0.54-bin.tar.gz"
...
default["flume_collector"]["endcollector_all_channels"]['dfw1']  = "mergespillable hdfsmerge-channel hdfslocal-channel platinumhdfs-channel eventhublocal-channel1 eventhublocal-channel2 eventhublocal-channel3 eventhublocal-channel4 eventhublocal-channel5 hdfsmergesecure-channel hdfslocalsecure-channel platinumhdfssecure-channel"

default["flume_collector"]["endcollector_all_sinks"]['dfw1'] = "mergekafkasink hdfsmerge-sink hdfslocal-sink1 hdfslocal-sink2 hdfslocal-sink3 platinumhdfs-sink1 platinumhdfs-sink2 platinumhdfs-sink3 eventhublocal-sink2 eventhublocal-sink3 eventhublocal-sink4 eventhublocal-sink5 eventhublocal-sink6 hdfsmergesecure-sink hdfslocalsecure-sink1 hdfslocalsecure-sink2 hdfslocalsecure-sink3 platinumhdfssecure-sink1 platinumhdfssecure-sink2 platinumhdfssecure-sink3"
...
default["flume_collector"]["endcollector_sources"]['dfw1']  = {
	 ...
	 :'kafka.topics' => "photon_flume_test"},
     "eventhublocalsrc1" => {
         :src_category => "dfw1eventhublocal1",
         :consumer_group => "dfw1eventhublocal1",
         :type => "org.apache.flume.source.kafka.MultiKafkaSource",
         :channels => "eventhublocal-channel1",
         :batchSize => 500,
         :'kafka.topics' => "stardust_generic_ingestion"},
     "eventhublocalsrc2" => {
         :src_category => "dfw1eventhublocal2",
         :consumer_group => "dfw1eventhublocal2",
         :type => "org.apache.flume.source.kafka.MultiKafkaSource",
         :channels => "eventhublocal-channel2",
         :batchSize => 500,
         :'kafka.topics' => "merge_tpce_organic_purchase_dsp"},
     "eventhublocalsrc3" => {
         :src_category => "dfw1eventhublocal3",
         :consumer_group => "dfw1eventhublocal3",
         :type => "org.apache.flume.source.kafka.MultiKafkaSource",
         :channels => "eventhublocal-channel3",
         :batchSize => 500,
         :'kafka.topics' => "merge_tpce_organic_download_dsp"},
     "eventhublocalsrc4" => {
         :src_category => "dfw1eventhublocal4",
         :consumer_group => "dfw1eventhublocal4",
         :type => "org.apache.flume.source.kafka.MultiKafkaSource",
         :channels => "eventhublocal-channel4",
         :batchSize => 500,
         :'kafka.topics' => "merge_tpce_organic_custom_dsp"},
     "eventhublocalsrc5" => {
         :src_category => "dfw1eventhublocal5",
         :consumer_group => "dfw1eventhublocal5",
         :type => "org.apache.flume.source.kafka.MultiKafkaSource",
         :channels => "eventhublocal-channel5",
         :batchSize => 500,
         :'kafka.topics' => "tpce_inorganic_download_dsp"}
       }
...
default["flume_collector"]["endcollector_local_eventhub_channels"]['dfw1']  = ["eventhublocal-channel1","eventhublocal-channel2","eventhublocal-channel3","eventhublocal-channel4","eventhublocal-channel5"]
...
default["flume_collector"]["endcollector_all_channels"]['dfw2']  = "mergespillable hdfsmerge-channel hdfslocal-channel platinumhdfs-channel hdfsmergesecure-channel hdfslocalsecure-channel platinumhdfssecure-channel eventhublocal-channel1 eventhublocal-channel2 eventhublocal-channel3"

default["flume_collector"]["endcollector_all_sinks"]['dfw2'] = "mergekafkasink hdfsmerge-sink hdfslocal-sink1 hdfslocal-sink2 hdfslocal-sink3 hdfslocal-sink4 platinumhdfs-sink1 platinumhdfs-sink2 platinumhdfs-sink3 hdfsmergesecure-sink hdfslocalsecure-sink1 hdfslocalsecure-sink2 hdfslocalsecure-sink3 hdfslocalsecure-sink4 platinumhdfssecure-sink1 platinumhdfssecure-sink2 platinumhdfssecure-sink3 kestrelsink kestrelsink1 kestrelsink2"
#Configure the sources for the Flume Collector
...
default["flume_collector"]["endcollector_local_eventhub_channels"]['dfw2']  = ["eventhublocal-channel1","eventhublocal-channel2","eventhublocal-channel3"]
